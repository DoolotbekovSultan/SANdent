...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthEntity&&(identical(other.access, _this.access) || other.access == _this.access)&&(identical(other.refresh, _this.refresh) || other.refresh == _this.refresh));
}
...
String toString() {
  final _this = this as AuthEntity;
  return 'AuthEntity(access: ${_this.access}, refresh: ${_this.refresh})';
}
...
class _AuthEntity implements AuthEntity {
  const _AuthEntity({required this.access, required this.refresh});
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthEntity&&(identical(other.access, access) || other.access == access)&&(identical(other.refresh, refresh) || other.refresh == refresh));
}
...
@override
String toString() {
    return 'AuthEntity(access: $access, refresh: $refresh)';
}
